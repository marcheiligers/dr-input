...
def tick(args)
  ...
  args.outputs.primitives << { y: 700, text: "#{args.state.text.value.length}/40", **DEBUG_LABEL, x: 1220 }
  args.outputs.primitives << { y: 662, text: args.state.multiline.size_px.to_s, **DEBUG_LABEL, x: 1150 }
